...
$query = "SELECT * FROM aset_pengadaan ORDER BY Nomor_Aset";
...
$judul0 = " ";
$judul = "Laporan Pengadaan Aset";
$judul2 = "Periode : 01 April 2012 s/d 15 April 2012";
$judul3 = "Tanggal Cetak : 16-04-2012";
$header = array(
array("label"=>"Nomor_Beli", "length"=>30, "align"=>"C"),
array("label"=>"Nomor_Aset", "length"=>30, "align"=>"C"),
array("label"=>"Nama_Aset", "length"=>30, "align"=>"C"),
array("label"=>"Tanggal_Beli", "length"=>20, "align"=>"C"),
array("label"=>"Harga", "length"=>20, "align"=>"C"),
array("label"=>"Label", "length"=>15, "align"=>"C"),
array("label"=>"NIK", "length"=>20, "align"=>"C"),
array("label"=>"Pemasok", "length"=>20, "align"=>"C"),
);
