...
$query = "SELECT * FROM aset_pengambilan ORDER BY NOMOR_ASET";
...
$judul0 = " ";
$judul = "Laporan Pengambilan Aset";
$judul2 = "Periode : 01 April 2012 s/d 15 April 2012";
$judul3 = "Tanggal Cetak : 16-04-2012";
$header = array(
array("label"=>"Nomor_Aset", "length"=>30, "align"=>"C"),
array("label"=>"Tanggal_Ambil", "length"=>30, "align"=>"C"),
array("label"=>"Nama_Aset", "length"=>35, "align"=>"C"),
array("label"=>"Satuan", "length"=>15, "align"=>"C"),
