...
$query = "SELECT * FROM aset_pemeliharaan ORDER BY NOMOR_ASET";
...
$judul0 = " ";
$judul = "Laporan Pemeliharaan Aset";
$judul2 = "Periode : 01 April 2012 s/d 15 April 2012";
$judul3 = "Tanggal Cetak : 16-04-2012";
$header = array(
array("label"=>"Nomor_Aset", "length"=>20, "align"=>"C"),
array("label"=>"NIK", "length"=>20, "align"=>"C"),
array("label"=>"Keluhan", "length"=>40, "align"=>"C"),
array("label"=>"Status_Aset", "length"=>20, "align"=>"C"),
array("label"=>"Biaya_Perbaikan", "length"=>20, "align"=>"C"),
array("label"=>"Petugas_Perbaikan", "length"=>30, "align"=>"C"),
);
