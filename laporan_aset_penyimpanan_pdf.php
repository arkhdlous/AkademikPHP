...
$query = "SELECT * FROM aset_penyimpanan ORDER BY NOMOR_ASET";
...
$judul0 = " ";
$judul = "Laporan Penyimpanan Aset";
...
array("label"=>"Jenis_Barang", "length"=>35, "align"=>"C"),
array("label"=>"Status_Aset", "length"=>20, "align"=>"C"),
array("label"=>"Satuan", "length"=>12, "align"=>"C"),
);
